# BBB permeability descriptor benchmark

This repository provides the processed molecular features, predefined feature subsets, and code required to reproduce the main findings of the BBB-permeability study, including model benchmarking, model refitting with cross-validated hyperparameter optimization, and independent external validation.
